...
def buy():
    ...
    if request.method == "POST":
        ...
        flash(f"You bouth {usd(total_cost)} dollars, in {shares} shares from the company {symbol}!")
        return redirect("/")
...
def register():
    ...
    if request.method == "POST":
        ...
        # Ensure password and confirmation is iqual
        ...
        """ mplement at least one personal touch of your choice:"""
        ...
        # Ensure insert new username into database
        ...
        for stock in stocks:
            if stock["symbol"] == symbol:
                if stock["total_shares"] < shares:
                    ...
                    flash(f"You Sold {usd(total_sale)} dollars, in {shares} shares from the company {symbol}!")
                    return redirect("/")
